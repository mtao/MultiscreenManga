    ...
    QObject(parent)
{
    ...
    QDir dir;
    do//keep trying hashes until dir exists... no one could have taken all hashes
    {
...
void MangaVolume::readImages(const QString & path)
{
    ...
    if(fileInfo.isDir()){
        QDir dir(path);
        QStringList fileList = dir.entryList(QDir::AllEntries | QDir::NoDotAndDotDot|QDir::NoSymLinks | QDir::Hidden,
